      ...
      <div class="section">
         <div>
            ...
            <div class="iter-wrapper">
               <div v-for="(i, i2) in championData.starting" :key="i2">
                  <div>
                     <div class="winrate">{{ winrate(i.v.games, i.v.wins) }}</div>
                     <div class="total">{{ i.v.games }}</div>
                  </div>
                  <div class="images">
                     <img v-if="i.k === '0000'" src="/images/no_items.jpg">
                     <img v-else :src="`https://ddragon.leagueoflegends.com/cdn/${store.patches[0]}/img/item/${o}.png`" v-for="(o, o2) in i.k.split('_')" :key="o2">
                  </div>
         ...
         <div>
            ...
            <div class="iter-wrapper">
               <div v-for="(i, i2) in championData.spells" :key="i2">
                  <div>
                     <div class="winrate">{{ winrate(i.v.games, i.v.wins) }}</div>
                     <div class="total">{{ i.v.games }}</div>
                  </div>
                  <div class="images">
                     <img :src="`/spells/${o}.webp`" v-for="(o, o2) in i.k.split('_')" :key="o2">
                  </div>
               </div>
            </div>
         </div>
         <div>
            ...
            <div class="iter-wrapper">
               <div v-for="(i, i2) in championData.skills" :key="i2">
                  <div>
                     <div class="winrate">{{ winrate(i.v.games, i.v.wins) }}</div>
                     <div class="total">{{ i.v.games }}</div>
                  </div>
